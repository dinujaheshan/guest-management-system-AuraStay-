...
if (mongoose.models.FoodOrderItem) {
  delete mongoose.models.FoodOrderItem;
}
export const FoodOrderItem: Model<IFoodOrderItem> = mongoose.model("FoodOrderItem", FoodOrderItemSchema);
